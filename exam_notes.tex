...
$$
Now, we need to find the path that actually leads to this. To do so, we just simply follow the elements, that meet the $\min$'s. By doing so we find the bath $1, 2, 4, 3$.
