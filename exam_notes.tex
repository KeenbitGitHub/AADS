...
\begin{center}
    ...
    \end{align*}
\end{center}
We see that the only variables in the objective functio with a positive coefficient is $x_1$ and $x_3$. Let us choose $x_1$ as our pivot elements. We isolate it in $x_4$, since this is the tighest function. Then, we have
$$
z = 8 + x_2 - x_3 - 2x_6
$$
\begin{center}
    ...
    \end{align*}
\end{center}
Then, we see, that the only variable in the objective function wtih a positive coefficient is $x_2$, which we choose as the objective function. Now, isolate it in $x_5$, as this is the only function with a negative $x_2$ coefficient. Then, we have
$$
z = 9 + \frac{5x_6}{3} - \frac{x_4}{3}
$$
\begin{center}
    \begin{align*}
        x_1 = 6 + \frac{5x_6}{3} - \frac{x_4}{3} \\
        x_2 = 1 + x_3 + \frac{x_6}{3} - \frac{2x_4}{3} \\
        x_6 = -x_5 \\
    \end{align*}
\end{center}
We then stop, as no non-basic variable appear in the objective function with a positive coefficient. Our solution is thus $(6, 1, 0, 0, 0, 0)$ with a value of $9$.
\\
\\
